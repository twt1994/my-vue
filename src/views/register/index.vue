<template>
  <div class="register-container">
    <el-form ref="registerForm" :model="registerForm" @keyup.enter.native="handleLogin" :rules="registerRules" class="register-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="telStr">
        ...
        <el-input v-model="registerForm.telStr" style="width:calc(100% - 200px)" name="username" type="text" auto-complete="on" placeholder="请输入手机验证码" />
      ...
      <el-form-item prop="password">
        ...
        <el-input v-model="registerForm.password" :type="pwdType" name="username" auto-complete="on" placeholder="请输入密码" />
